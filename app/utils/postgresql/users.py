...
from postgresql.model import ClientPotgreSQL
...
async def get_user_by_id(bd: ClientPotgreSQL, id: int) -> Optional[Dict[str, Any]]:
    """
...
async def set_user(bd: ClientPotgreSQL, item: Dict[str, Any]) -> Optional[str]:
    """
...
async def isAccess(bd: ClientPotgreSQL, id: int) -> bool:
    """
...
async def isAdmin(bd: ClientPotgreSQL, id: int) -> bool:
    """
...
async def update_user(bd: ClientPotgreSQL, update_values: Dict[str, Any], id: int) -> Optional[str]:
    """
...
async def update_state(bd: ClientPotgreSQL, id: int, value: str) -> Optional[str]:
    """
...
async def get_state(bd: ClientPotgreSQL, id: int) -> Optional[str]:
    """
...
async def isState(bd: ClientPotgreSQL, id: int, value: str) -> bool:
    """
...
async def inState(bd: ClientPotgreSQL, id: int, value: str) -> bool:
    """
